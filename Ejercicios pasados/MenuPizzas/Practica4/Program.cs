    ...
    public void BonosEmpleados()
    {
        ...
        switch (departamento)
        {
            case "a" when ant < 24:
                ...
                Console.WriteLine($"Bono: {totalBono} | Bono extra por hijos: {bonoExtra} | Total: {(totalBono+bonoExtra)}");
                break;
            case "a" when ant >= 24:
    ...
    public void Operaciones()
    {
        ...
        switch (operacion)
        {
            ...
            case 3:
                ...
                var lados = Math.Sqrt(((Math.Pow(2, (mayor/2))) + (Math.Pow(2, (menor/2)))));
                perimetro = 4 * lados;
                area = (mayor * menor) / 2;
                Console.WriteLine($"Area: {area} | Perímetro: {Math.Round(perimetro)}");
                break;
            default:
